...
impl PyNumberProtocol for BinaryArithmetic {
    fn __add__(lhs: &PyBaseObject, rhs: &PyBaseObject) -> PyResult<String> {
        Ok(format!("{:?} + {:?}", lhs, rhs))
    }

    fn __sub__(lhs: &PyBaseObject, rhs: &PyBaseObject) -> PyResult<String> {
        Ok(format!("{:?} - {:?}", lhs, rhs))
    }

    fn __mul__(lhs: &PyBaseObject, rhs: &PyBaseObject) -> PyResult<String> {
        Ok(format!("{:?} * {:?}", lhs, rhs))
    }

    fn __lshift__(lhs: &PyBaseObject, rhs: &PyBaseObject) -> PyResult<String> {
        Ok(format!("{:?} << {:?}", lhs, rhs))
    }

    fn __rshift__(lhs: &PyBaseObject, rhs: &PyBaseObject) -> PyResult<String> {
        Ok(format!("{:?} >> {:?}", lhs, rhs))
    }

    fn __and__(lhs: &PyBaseObject, rhs: &PyBaseObject) -> PyResult<String> {
        Ok(format!("{:?} & {:?}", lhs, rhs))
    }

    fn __xor__(lhs: &PyBaseObject, rhs: &PyBaseObject) -> PyResult<String> {
        Ok(format!("{:?} ^ {:?}", lhs, rhs))
    }

    fn __or__(lhs: &PyBaseObject, rhs: &PyBaseObject) -> PyResult<String> {
        Ok(format!("{:?} | {:?}", lhs, rhs))
    }
}
...
impl PyObjectProtocol for RichComparisons {
    ...
    fn __richcmp__(&self, other: &PyBaseObject, op: CompareOp) -> PyResult<String> {
        match op {
...
impl PyObjectProtocol for RichComparisons2 {
    ...
    fn __richcmp__(&self, _other: &PyBaseObject, op: CompareOp) -> PyResult<PyObject> {
