...
macro_rules! py_binary_func {
    ...
    ($trait:ident, $class:ident :: $f:ident, $res_type:ty, $conv:expr, $return:ty) => {{
            ...
            T: for<'p> $trait<'p>,
        {
            ...
            let py = $crate::Python::assume_gil_acquired();
            let slf = py.mut_from_borrowed_ptr::<T>(slf);
            let arg = py.from_borrowed_ptr::<$crate::types::PyBaseObject>(arg);
...
macro_rules! py_binary_num_func {
    ($trait:ident, $class:ident :: $f:ident, $res_type:ty, $conv:expr) => {{
            ...
            T: for<'p> $trait<'p>,
        {
            ...
            let _pool = $crate::GILPool::new();
            let py = $crate::Python::assume_gil_acquired();
            let lhs = py.from_borrowed_ptr::<$crate::types::PyBaseObject>(lhs);
            let rhs = py.from_borrowed_ptr::<$crate::types::PyBaseObject>(rhs);
...
macro_rules! py_ternary_func {
    ...
    ($trait:ident, $class:ident :: $f:ident, $res_type:ty, $conv:expr, $return_type:ty) => {{
            ...
            T: for<'p> $trait<'p>,
        {
            ...
            let py = $crate::Python::assume_gil_acquired();
            let slf = py.mut_from_borrowed_ptr::<T>(slf);
            let arg1 = py.from_borrowed_ptr::<$crate::types::PyBaseObject>(arg1);
            let arg2 = py.from_borrowed_ptr::<$crate::types::PyBaseObject>(arg2);
...
macro_rules! py_ternary_num_func {
    ($trait:ident, $class:ident :: $f:ident, $res_type:ty, $conv:expr) => {{
            ...
            T: for<'p> $trait<'p>,
        {
            ...
            let arg1 = py.from_borrowed_ptr::<$crate::types::PyBaseObject>(arg1);
            let arg2 = py.from_borrowed_ptr::<$crate::types::PyBaseObject>(arg2);
            let arg3 = py.from_borrowed_ptr::<$crate::types::PyBaseObject>(arg3);
    ...
    ($trait_name:ident, $generic:ident, $fn_set:ident) => {{
            ...
            T: for<'p> $trait_name<'p>,
        {
            ...
            let result = if value.is_null() {
                ...
                let name = py.mut_from_borrowed_ptr::<$crate::types::PyBaseObject>(name);
                let value = py.from_borrowed_ptr::<$crate::types::PyBaseObject>(value);
                match name.extract() {
    ...
    ($trait_name:ident, $generic:ident, $fn_del:ident) => {{
            ...
            U: for<'p> $trait_name<'p>,
        {
            ...
            let result = if value.is_null() {
                ...
                let name = py.from_borrowed_ptr::<$crate::types::PyBaseObject>(name);
