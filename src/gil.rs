...
pub unsafe fn register_owned(_py: Python, obj: NonNull<ffi::PyObject>) -> &PyBaseObject {
    let pool = &mut *POOL;
    &*(pool.owned.push_back(obj) as *const _ as *const PyBaseObject)
}

pub unsafe fn register_borrowed(_py: Python, obj: NonNull<ffi::PyObject>) -> &PyBaseObject {
    let pool = &mut *POOL;
    &*(pool.borrowed.push_back(obj) as *const _ as *const PyBaseObject)
}
